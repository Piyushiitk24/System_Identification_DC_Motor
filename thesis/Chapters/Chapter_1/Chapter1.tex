...
The work is centred on \textbf{open-loop} identification and validation, and concludes with a \textbf{closed-loop} test of whether the identified structure improves reference tracking:
\begin{enumerate}
